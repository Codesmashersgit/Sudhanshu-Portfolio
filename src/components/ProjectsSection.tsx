...
const CARD_COLORS = [
  '#FF3B30', '#FF9500', '#FFCC00', '#34C759', '#007AFF', '#5856D6', '#FF2D55', '#AF52DE', '#00C7BE',
];
...
export const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="relative w-full h-screen bg-white text-black flex items-center justify-center overflow-hidden select-none">
      <div
